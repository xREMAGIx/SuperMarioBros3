...
#define VENUS_FIRE_TRAP_POINT_OFFSET_Y 32
#define VENUS_FIRE_TRAP_FIRE_BALL_OFFSET_X	8
#define VENUS_FIRE_TRAP_FIRE_BALL_OFFSET_Y	6

#define VENUS_FIRE_TRAP_POINT_DIE 100
