...
#define RED_KOOPA_JUMP_DIE_SPEED	0.5f
...
protected:
	...
	virtual int IsCollidable() { return ((state != RED_KOOPA_STATE_DIE) && (state != RED_KOOPA_STATE_JUMP_DIE)); };
